...
if __name__ == '__main__':
    # split_test = splitbase(r'/home/dingjian/data/dota/val/images',
    #                   r'/home/dingjian/data/dota/valsplit',
    #                   num_process=64)
    # split_test.splitdata(1)
    # split_test = splitbase(r'/data8T/miki/OBB_data/DOTAv1.5/test/images',
    #                   r'/data8T/miki/OBB_data/DOTAv1.5_1024/test/images',
    #                   num_process=64)
    # split_test.splitdata(1)

    split_test = splitbase(r'/media/data/miki/OBB_data/DOTAv1.0/test/images',
                      r'/media/data/miki/OBB_data/DOTAv1.0_1024/test/images',
                      num_process=80)
    split_test.splitdata(1)
