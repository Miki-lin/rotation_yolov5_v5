...
from utils.general import check_img_size, check_requirements, check_imshow, non_max_suppression, apply_classifier, \
    scale_coords, xyxy2xywh, strip_optimizer, set_logging, increment_path, save_one_box, scale_labels, \
    rotate_non_max_suppression, longsideformat2cvminAreaRect
from utils.plots import colors, plot_one_box, plot_one_rotated_box
            ...
            if det is not None and len(det):
                ...
                for *rbox, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        conf_str = '%.3f' % conf
                        img_name = Path(p).stem
                        out_path = str(txt_path + '/result_before_merge')
                    ...
                    if save_img or opt.save_crop or view_img:  # Add bbox to image
                        ...
                        plot_one_rotated_box(rbox, im0, label=label, color=colors(c, True),
                                             line_thickness=opt.line_thickness, pi_format=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='/media/data/miki/OBB_data/DOTAv1.0_1024/test/images', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--project', default='/media/data/miki/OBB_data/DOTAv1.0_1024/test/detection0530', help='save results to project/name')
