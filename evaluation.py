...
from utils.DOTA_devkit import polyiou
...
def evaluation(detoutput, imageset, annopath, classnames):
    ...
    """
    result_before_merge_path = str(detoutput + '/labels/result_before_merge')
    result_merged_path = str(detoutput + '/labels/result_merged')
    result_classname_path = str(detoutput + '/labels/result_classname')
    imageset_name_file_path = str(detoutput + '/labels')
...
if __name__ == '__main__':
    ...
    # val
    evaluation(
        detoutput='/media/data/miki/OBB_data/DOTAv1.0_1024/test/detection0530/exp6',
    ...
    draw_DOTA_image(imgsrcpath=r'/media/data/miki/OBB_data/DOTAv1.5/val/images',
                    imglabelspath=r'/media/data/miki/OBB_data/DOTAv1.5_1024/val/detection052116/exp/labels/result_merged',
                    dstpath=r'/media/data/miki/OBB_data/DOTAv1.5_1024/val/detection052116/exp/images/merged_drawed',
                    extractclassname=classnames,
                    thickness=2
                    )
    # test
    # evaluation(
    #     detoutput='/data8T/miki/OBB_data/DOTAv1.5_split/test/detection0505',
    #     imageset=r'/data8T/miki/OBB_data/DOTAv1.5/val/images',
    #     annopath=r'/data8T/miki/OBB_data/DOTAv1.5/val/labelTxt/{:s}.txt',
    #     classnames=classnames
    # )
    #
    # draw_DOTA_image(imgsrcpath=r'/data8T/miki/OBB_data/DOTAv1.5/val/images',
    #                 imglabelspath=r'/data8T/miki/OBB_data/DOTAv1.5_split/test/detection0505/result_txt/result_merged',
    #                 dstpath=r'/data8T/miki/OBB_data/DOTAv1.5_split/test/images/detection0505/merged_drawed',
    #                 extractclassname=classnames,
    #                 thickness=2
    #                 )
